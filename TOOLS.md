...
| **Собери меры поддержки** | `social-research-agent` | Социальный исследователь: сбор перечней мер по регионам РФ (триггер: точная фраза «Собери меры поддержки по всем категориям и всем регионам», только Ирина) |
| **Добавь категорию / Новая категория / Расширь список** | `social-consult-agent` | Добавление новой категории соцподдержки (через диалог с Ириной) |
